...
// CreateExecutionConfirmation is the public write contract for 执行确认. Status is deliberately
// omitted so callers cannot bypass the service state machine.
type CreateExecutionConfirmation struct {
...
type UpdateExecutionConfirmation struct {
